...
class TimingExtension : BeforeTestExecutionCallback, AfterTestExecutionCallback, AfterAllCallback {
    ...
    override fun afterAll(context: ExtensionContext?) {
        ...
        println("thread id in afterAll callback: ${Thread.currentThread()}")
    }
}
