...
import sys
from typing import Any, Dict, List, Tuple, NoReturn, Sequence, Optional, TypeVar, Callable
import random
...
class Game:
    ...
    def player_order(self, start=None) -> List[str]:
...
def do_twice(func: Callable[[str], str], arg: str) -> None:
    print(func(arg))
    print(func(arg))
